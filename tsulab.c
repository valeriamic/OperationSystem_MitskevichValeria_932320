...
#define HALE_BOPP_PERIHELION_EPOCH_SEC 859334400LL 
#define SECONDS_IN_DAY (24 * 60 * 60LL)
                             ...
                             size_t buffer_length, loff_t *offset)
{
    ...
    diff_sec = current_time.tv_sec - HALE_BOPP_PERIHELION_EPOCH_SEC;
    days = diff_sec / SECONDS_IN_DAY;
